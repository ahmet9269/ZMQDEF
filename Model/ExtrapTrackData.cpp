...
ExtrapTrackData::ExtrapTrackData() {
    ...
    void ExtrapTrackData::validateXVelocityECEF(float value) const {
...
void ExtrapTrackData::setTrackId(const uint32_t& value) {
...
void ExtrapTrackData::setXVelocityECEF(const float& value) {
